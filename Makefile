FILES = ./build/kernel.asm.o  ./build/kernel.o ./build/memory/memory.o ./build/idt/idt.o ./build/idt/idt.asm.o ./build/io/io.asm.o	./build/memory/heap.o ./build/memory/kheap.o ./build/io/keyboard.o
INCLUDES = -I./src
